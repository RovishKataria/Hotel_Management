...
class Hotel_Management:
    def __init__(self):
        ...
        self.Button1.configure(text='''1. CHECK INN''')
        ...
        self.Button2.configure(text='''2. SHOW GUEST LIST''')
        ...
        self.Button3.configure(text='''3. CHECK OUT''')
        self.Button3.configure(width=566)
        self.Button3.configure(command=click_checkout)

        self.Button4 = Button(self.Frame1)
        self.Button4.place(relx=0.18, rely=0.61, height=103, width=566)
        ...
        self.Button4.configure(text='''4. GET INFO OF ANY GUEST''')
        self.Button4.configure(width=566)
        self.Button4.configure(command=click_getinfo)

        self.Button5 = Button(self.Frame1)
        self.Button5.place(relx=0.18, rely=0.77, height=103, width=566)
        ...
        self.Button5.configure(text='''5. EXIT''')
